document.addEventListener("DOMContentLoaded", function () {
  ...
  const situationPage =
    document.getElementById("situationPage");
  ...
  const rewardPage =
    document.getElementById("rewardPage");
  ...
  const letsLieButton =
    document.getElementById("letsLieButton");
  ...
  const rewardLoadingProgress =
    document.getElementById(
      "rewardLoadingProgress"
    );

  const rewardLoadingPercent =
    document.getElementById(
      "rewardLoadingPercent"
    );
  ...
  const finalExcuse =
    document.getElementById("finalExcuse");

  const excuseCard =
    document.getElementById("excuseCard");
  ...
  if (letsLieButton) {
    ...
    letsLieButton.addEventListener(
      "click",
      function () {
  ...
  function showRewardLoading() {
    ...
    if (databaseUnlocked) {
      ...
      databaseUnlocked.classList.remove(
        "show"
      );
      ...
      setInterval(function () {
        ...
        if (progress >= 100) {
          ...
          if (databaseUnlocked) {
            ...
            databaseUnlocked.classList.add(
              "show"
            );
